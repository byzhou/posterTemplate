      ...
      \begin{beamercolorbox}[center,wd=\textwidth]{postercolumn}
        \begin{minipage}[T]{.95\textwidth} % tweaks the width, makes a new \textwidth
          \parbox[t][\columnheight]{\textwidth}{ % must be some better way to set the the height, width and textwidth simultaneously
            ...
            \begin{block}{Results}
              \begin{itemize}
                \item \textbf{\boldmath 95\% \cls{} Upper Limits for $m_H = 125 \GeVcc{}$}:
                \begin{itemize}
            ...
            \begin{block}{Conclusions}
              \begin{itemize}
                ...
                \item \textbf{\boldmath Most Significant Excess Found $\sim1\sigma$}
                \item \textbf{\boldmath 95\% \cls{} Limit on $\sigma/\sigma_{SM}$ for $m_H= 125\GeVcc{}$:}
                \begin{itemize}
                  \item \textbf{\boldmath Expected: $5.1^{+2.3}_{-1.5}\times$SM}
                  \item \textbf{\boldmath Observed: $7.4\times$SM}
                \end{itemize}
                \item \textbf{\boldmath Best Fit $\sigma/\sigma_{SM}=2.9^{+2.8}_{-2.7}$ for $m_H= 125.7\GeVcc{}$}
              \end{itemize}
            \end{block}
          }
          % ---------------------------------------------------------%
