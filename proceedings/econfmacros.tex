...
\def\ptmiss{\ensuremath{\pt^{\mathrm{miss}}}}
\def\Mmumu{\ensuremath{m_{\mu\mu}}}
\def\mm{\ensuremath{\mu^+\mu^-}}
\def\hmm{\ensuremath{\mathrm{H}\to\mu^+\mu^-}}
\def\mh{\ensuremath{\mathrm{m_H}}}
\def\TeV{\ensuremath{\mathrm{Te\kern -0.1em V}}}
\def\GeV{\ensuremath{\mathrm{Ge\kern -0.1em V}}}
%\def\GeVc{\ensuremath{\mathrm{Ge\kern -0.1em V\!/c}}}
%\def\GeVcc{\ensuremath{\mathrm{Ge\kern -0.1em V\!/c^2}}}
\def\GeVc{\GeV{}}
\def\GeVcc{\GeV{}}
